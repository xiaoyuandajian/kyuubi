...
public final class GrpcTestServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<TestOpenSessionRequest, TestOpenSessionResponse>
  ...
  public static io.grpc.MethodDescriptor<TestOpenSessionRequest, TestOpenSessionResponse>
      getTestOpenSessionMethod() {
    io.grpc.MethodDescriptor<TestOpenSessionRequest, TestOpenSessionResponse>
        getTestOpenSessionMethod;
    if ((getTestOpenSessionMethod = GrpcTestServiceGrpc.getTestOpenSessionMethod) == null) {
      synchronized (GrpcTestServiceGrpc.class) {
        if ((getTestOpenSessionMethod = GrpcTestServiceGrpc.getTestOpenSessionMethod) == null) {
          GrpcTestServiceGrpc.getTestOpenSessionMethod =
              getTestOpenSessionMethod =
                  io.grpc.MethodDescriptor
                      .<TestOpenSessionRequest, TestOpenSessionResponse>newBuilder()
                      ...
                      .setSchemaDescriptor(
                          new GrpcTestServiceMethodDescriptorSupplier("TestOpenSession"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<TestAddRequest, TestAddResponse>
      getTestAddMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<TestAddRequest, TestAddResponse> getTestAddMethod() {
    ...
    if ((getTestAddMethod = GrpcTestServiceGrpc.getTestAddMethod) == null) {
      synchronized (GrpcTestServiceGrpc.class) {
        if ((getTestAddMethod = GrpcTestServiceGrpc.getTestAddMethod) == null) {
          GrpcTestServiceGrpc.getTestAddMethod =
              getTestAddMethod =
  ...
  public static GrpcTestServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GrpcTestServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<GrpcTestServiceStub>() {
          @Override
          public GrpcTestServiceStub newStub(
   ...
   */
  public static GrpcTestServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GrpcTestServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<GrpcTestServiceBlockingStub>() {
          @Override
          public GrpcTestServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static GrpcTestServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GrpcTestServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<GrpcTestServiceFutureStub>() {
          @Override
          public GrpcTestServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    /** */
    default void testOpenSession(
        TestOpenSessionRequest request,
        io.grpc.stub.StreamObserver<TestOpenSessionResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getTestOpenSessionMethod(), responseObserver);
    }

    /** */
    default void testAdd(
        TestAddRequest request, io.grpc.stub.StreamObserver<TestAddResponse> responseObserver) {
  ...
  public abstract static class GrpcTestServiceImplBase
  ...
  public static final class GrpcTestServiceStub
    ...
    private GrpcTestServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @Override
    protected GrpcTestServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new GrpcTestServiceStub(channel, callOptions);
    }
    ...
    public void testOpenSession(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getTestOpenSessionMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  ...
  public static final class GrpcTestServiceBlockingStub
    ...
    private GrpcTestServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
  ...
  public static final class GrpcTestServiceFutureStub
    ...
    private GrpcTestServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    /** */
    public com.google.common.util.concurrent.ListenableFuture<TestOpenSessionResponse>
        testOpenSession(TestOpenSessionRequest request) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<TestOpenSessionRequest, TestOpenSessionResponse>(
                    service, METHODID_TEST_OPEN_SESSION)))
        .addMethod(
            getTestAddMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<TestAddRequest, TestAddResponse>(service, METHODID_TEST_ADD)))
        .build();
  }

  private abstract static class GrpcTestServiceBaseDescriptorSupplier
