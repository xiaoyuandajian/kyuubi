...
public interface AggregateOrBuilder extends
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.Aggregate.GroupType getGroupType();
   ...
   * <code>repeated .spark.connect.Expression aggregate_expressions = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getAggregateExpressions(int index);
  /**
   * <pre>
   * (Required) List of values that will be translated to columns in the output DataFrame.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression aggregate_expressions = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getAggregateExpressionsOrBuilder(
      int index);
   ...
   * @return The pivot.
   */
  org.apache.kyuubi.engine.spark.connect.proto.Aggregate.Pivot getPivot();
  /**
   * <pre>
   * (Optional) Pivots a column of the current `DataFrame` and performs the specified aggregation.
   * </pre>
   ...
   * <code>.spark.connect.Aggregate.Pivot pivot = 5;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Aggregate.PivotOrBuilder getPivotOrBuilder();
}
