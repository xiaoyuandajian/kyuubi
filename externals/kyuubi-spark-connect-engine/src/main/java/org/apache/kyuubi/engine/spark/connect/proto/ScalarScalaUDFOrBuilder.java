...
public interface ScalarScalaUDFOrBuilder extends
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.proto.DataType> 
      getInputTypesList();
  /**
   * <pre>
   * (Optional) Input type(s) of the UDF
   ...
   * <code>repeated .spark.connect.DataType inputTypes = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.DataType getInputTypes(int index);
  /**
   * <pre>
   * (Optional) Input type(s) of the UDF
   * </pre>
   ...
   * <code>repeated .spark.connect.DataType inputTypes = 2;</code>
   */
  java.util.List<? extends org.apache.kyuubi.engine.spark.connect.proto.DataTypeOrBuilder> 
   ...
   * <code>repeated .spark.connect.DataType inputTypes = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.DataTypeOrBuilder getInputTypesOrBuilder(
      int index);
