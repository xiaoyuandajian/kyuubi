...
@javax.annotation.Generated(
    ...
    comments = "Source: kyuubi/spark/connect/base.proto")
...
public final class SparkConnectServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ExecutePlanRequest, ExecutePlanResponse>
  ...
  public static io.grpc.MethodDescriptor<ExecutePlanRequest, ExecutePlanResponse>
      getExecutePlanMethod() {
          ...
          SparkConnectServiceGrpc.getExecutePlanMethod =
              getExecutePlanMethod =
                  io.grpc.MethodDescriptor.<ExecutePlanRequest, ExecutePlanResponse>newBuilder()
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("ExecutePlan"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<AnalyzePlanRequest, AnalyzePlanResponse>
  ...
  public static io.grpc.MethodDescriptor<AnalyzePlanRequest, AnalyzePlanResponse>
      getAnalyzePlanMethod() {
          ...
          SparkConnectServiceGrpc.getAnalyzePlanMethod =
              getAnalyzePlanMethod =
                  io.grpc.MethodDescriptor.<AnalyzePlanRequest, AnalyzePlanResponse>newBuilder()
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("AnalyzePlan"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<ConfigRequest, ConfigResponse> getConfigMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ConfigRequest, ConfigResponse> getConfigMethod() {
    ...
    if ((getConfigMethod = SparkConnectServiceGrpc.getConfigMethod) == null) {
      synchronized (SparkConnectServiceGrpc.class) {
        if ((getConfigMethod = SparkConnectServiceGrpc.getConfigMethod) == null) {
          SparkConnectServiceGrpc.getConfigMethod =
              getConfigMethod =
                  io.grpc.MethodDescriptor.<ConfigRequest, ConfigResponse>newBuilder()
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("Config"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<AddArtifactsRequest, AddArtifactsResponse>
  ...
  public static io.grpc.MethodDescriptor<AddArtifactsRequest, AddArtifactsResponse>
      getAddArtifactsMethod() {
    ...
    if ((getAddArtifactsMethod = SparkConnectServiceGrpc.getAddArtifactsMethod) == null) {
      synchronized (SparkConnectServiceGrpc.class) {
        if ((getAddArtifactsMethod = SparkConnectServiceGrpc.getAddArtifactsMethod) == null) {
          SparkConnectServiceGrpc.getAddArtifactsMethod =
              getAddArtifactsMethod =
                  io.grpc.MethodDescriptor.<AddArtifactsRequest, AddArtifactsResponse>newBuilder()
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("AddArtifacts"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<
          ArtifactStatusesRequest, ArtifactStatusesResponse>
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ArtifactStatusesRequest, ArtifactStatusesResponse>
      getArtifactStatusMethod() {
    io.grpc.MethodDescriptor<ArtifactStatusesRequest, ArtifactStatusesResponse>
        getArtifactStatusMethod;
    if ((getArtifactStatusMethod = SparkConnectServiceGrpc.getArtifactStatusMethod) == null) {
      synchronized (SparkConnectServiceGrpc.class) {
        if ((getArtifactStatusMethod = SparkConnectServiceGrpc.getArtifactStatusMethod) == null) {
          SparkConnectServiceGrpc.getArtifactStatusMethod =
              getArtifactStatusMethod =
                  io.grpc.MethodDescriptor
                      .<ArtifactStatusesRequest, ArtifactStatusesResponse>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("ArtifactStatus"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<InterruptRequest, InterruptResponse>
      getInterruptMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<InterruptRequest, InterruptResponse> getInterruptMethod() {
          ...
          SparkConnectServiceGrpc.getInterruptMethod =
              getInterruptMethod =
                  io.grpc.MethodDescriptor.<InterruptRequest, InterruptResponse>newBuilder()
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("Interrupt"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<ReattachExecuteRequest, ExecutePlanResponse>
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = ExecutePlanResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ReattachExecuteRequest, ExecutePlanResponse>
      getReattachExecuteMethod() {
                  ...
                  io.grpc.MethodDescriptor.<ReattachExecuteRequest, ExecutePlanResponse>newBuilder()
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              ExecutePlanResponse.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("ReattachExecute"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<ReleaseExecuteRequest, ReleaseExecuteResponse>
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ReleaseExecuteRequest, ReleaseExecuteResponse>
      getReleaseExecuteMethod() {
      ...
      synchronized (SparkConnectServiceGrpc.class) {
        if ((getReleaseExecuteMethod = SparkConnectServiceGrpc.getReleaseExecuteMethod) == null) {
          SparkConnectServiceGrpc.getReleaseExecuteMethod =
              getReleaseExecuteMethod =
                  io.grpc.MethodDescriptor
                      .<ReleaseExecuteRequest, ReleaseExecuteResponse>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("ReleaseExecute"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<ReleaseSessionRequest, ReleaseSessionResponse>
      getReleaseSessionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ReleaseSession",
      requestType = ReleaseSessionRequest.class,
      responseType = ReleaseSessionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ReleaseSessionRequest, ReleaseSessionResponse>
      getReleaseSessionMethod() {
    io.grpc.MethodDescriptor<ReleaseSessionRequest, ReleaseSessionResponse> getReleaseSessionMethod;
    if ((getReleaseSessionMethod = SparkConnectServiceGrpc.getReleaseSessionMethod) == null) {
      synchronized (SparkConnectServiceGrpc.class) {
        if ((getReleaseSessionMethod = SparkConnectServiceGrpc.getReleaseSessionMethod) == null) {
          SparkConnectServiceGrpc.getReleaseSessionMethod =
              getReleaseSessionMethod =
                  io.grpc.MethodDescriptor
                      .<ReleaseSessionRequest, ReleaseSessionResponse>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ReleaseSession"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              ReleaseSessionRequest.getDefaultInstance()))
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              ReleaseSessionResponse.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("ReleaseSession"))
                      .build();
        }
      }
    }
    return getReleaseSessionMethod;
  }
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<FetchErrorDetailsRequest, FetchErrorDetailsResponse>
      getFetchErrorDetailsMethod() {
    io.grpc.MethodDescriptor<FetchErrorDetailsRequest, FetchErrorDetailsResponse>
        getFetchErrorDetailsMethod;
    if ((getFetchErrorDetailsMethod = SparkConnectServiceGrpc.getFetchErrorDetailsMethod) == null) {
      synchronized (SparkConnectServiceGrpc.class) {
        if ((getFetchErrorDetailsMethod = SparkConnectServiceGrpc.getFetchErrorDetailsMethod)
            == null) {
          SparkConnectServiceGrpc.getFetchErrorDetailsMethod =
              getFetchErrorDetailsMethod =
                  io.grpc.MethodDescriptor
                      .<FetchErrorDetailsRequest, FetchErrorDetailsResponse>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setSchemaDescriptor(
                          new SparkConnectServiceMethodDescriptorSupplier("FetchErrorDetails"))
                      .build();
        }
      }
    }
  ...
  public static SparkConnectServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SparkConnectServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SparkConnectServiceStub>() {
          @Override
          public SparkConnectServiceStub newStub(
   ...
   */
  public static SparkConnectServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SparkConnectServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SparkConnectServiceBlockingStub>() {
          @Override
          public SparkConnectServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static SparkConnectServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SparkConnectServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SparkConnectServiceFutureStub>() {
          @Override
          public SparkConnectServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     */
    default void config(
        ConfigRequest request, io.grpc.stub.StreamObserver<ConfigResponse> responseObserver) {
    ...
    default io.grpc.stub.StreamObserver<AddArtifactsRequest> addArtifacts(
      ...
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(
          getAddArtifactsMethod(), responseObserver);
    }
    ...
    default void interrupt(
        InterruptRequest request, io.grpc.stub.StreamObserver<InterruptResponse> responseObserver) {
     ...
     * </pre>
     */
    default void reattachExecute(
        ReattachExecuteRequest request,
        io.grpc.stub.StreamObserver<ExecutePlanResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getReattachExecuteMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void releaseSession(
        ReleaseSessionRequest request,
        io.grpc.stub.StreamObserver<ReleaseSessionResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getReleaseSessionMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public abstract static class SparkConnectServiceImplBase
  ...
  public static final class SparkConnectServiceStub
    ...
    private SparkConnectServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void executePlan(
      ...
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getExecutePlanMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void analyzePlan(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getAnalyzePlanMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void artifactStatus(
        ...
        io.grpc.stub.StreamObserver<ArtifactStatusesResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getArtifactStatusMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void reattachExecute(
        ...
        io.grpc.stub.StreamObserver<ExecutePlanResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getReattachExecuteMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void releaseExecute(
        ...
        io.grpc.stub.StreamObserver<ReleaseExecuteResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getReleaseExecuteMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void releaseSession(
        ...
        io.grpc.stub.StreamObserver<ReleaseSessionResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getReleaseSessionMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void fetchErrorDetails(
        ...
        io.grpc.stub.StreamObserver<FetchErrorDetailsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getFetchErrorDetailsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class SparkConnectServiceBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<ExecutePlanResponse> executePlan(ExecutePlanRequest request) {
     ...
     * </pre>
     */
    public java.util.Iterator<ExecutePlanResponse> reattachExecute(ReattachExecuteRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
    ...
    public ReleaseSessionResponse releaseSession(ReleaseSessionRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
          getChannel(), getReleaseSessionMethod(), getCallOptions(), request);
    }
  ...
  public static final class SparkConnectServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ArtifactStatusesResponse>
        artifactStatus(ArtifactStatusesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ReleaseExecuteResponse>
        releaseExecute(ReleaseExecuteRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<ReleaseSessionResponse>
        releaseSession(ReleaseSessionRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
          getChannel().newCall(getReleaseSessionMethod(), getCallOptions()), request);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<FetchErrorDetailsResponse>
        fetchErrorDetails(FetchErrorDetailsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_RELEASE_SESSION = 7;
  private static final int METHODID_FETCH_ERROR_DETAILS = 8;
  private static final int METHODID_ADD_ARTIFACTS = 9;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXECUTE_PLAN:
          serviceImpl.executePlan(
              (ExecutePlanRequest) request,
              (io.grpc.stub.StreamObserver<ExecutePlanResponse>) responseObserver);
          break;
        case METHODID_ANALYZE_PLAN:
          serviceImpl.analyzePlan(
              (AnalyzePlanRequest) request,
              (io.grpc.stub.StreamObserver<AnalyzePlanResponse>) responseObserver);
          break;
        ...
        case METHODID_ARTIFACT_STATUS:
          serviceImpl.artifactStatus(
              (ArtifactStatusesRequest) request,
              (io.grpc.stub.StreamObserver<ArtifactStatusesResponse>) responseObserver);
          break;
        case METHODID_INTERRUPT:
          serviceImpl.interrupt(
              (InterruptRequest) request,
              (io.grpc.stub.StreamObserver<InterruptResponse>) responseObserver);
          break;
        case METHODID_REATTACH_EXECUTE:
          serviceImpl.reattachExecute(
              (ReattachExecuteRequest) request,
              (io.grpc.stub.StreamObserver<ExecutePlanResponse>) responseObserver);
          break;
        case METHODID_RELEASE_EXECUTE:
          serviceImpl.releaseExecute(
              (ReleaseExecuteRequest) request,
              (io.grpc.stub.StreamObserver<ReleaseExecuteResponse>) responseObserver);
          break;
        case METHODID_RELEASE_SESSION:
          serviceImpl.releaseSession(
              (ReleaseSessionRequest) request,
              (io.grpc.stub.StreamObserver<ReleaseSessionResponse>) responseObserver);
          break;
        case METHODID_FETCH_ERROR_DETAILS:
          serviceImpl.fetchErrorDetails(
              (FetchErrorDetailsRequest) request,
              (io.grpc.stub.StreamObserver<FetchErrorDetailsResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
                new MethodHandlers<ExecutePlanRequest, ExecutePlanResponse>(
                    service, METHODID_EXECUTE_PLAN)))
        .addMethod(
            getAnalyzePlanMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<AnalyzePlanRequest, AnalyzePlanResponse>(
                    service, METHODID_ANALYZE_PLAN)))
        .addMethod(
            getConfigMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<ConfigRequest, ConfigResponse>(service, METHODID_CONFIG)))
        .addMethod(
            getAddArtifactsMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
                new MethodHandlers<AddArtifactsRequest, AddArtifactsResponse>(
                    service, METHODID_ADD_ARTIFACTS)))
        .addMethod(
            getArtifactStatusMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<ArtifactStatusesRequest, ArtifactStatusesResponse>(
                    service, METHODID_ARTIFACT_STATUS)))
        .addMethod(
            getInterruptMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<InterruptRequest, InterruptResponse>(
                    service, METHODID_INTERRUPT)))
        .addMethod(
            getReattachExecuteMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
                new MethodHandlers<ReattachExecuteRequest, ExecutePlanResponse>(
                    service, METHODID_REATTACH_EXECUTE)))
        .addMethod(
            getReleaseExecuteMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<ReleaseExecuteRequest, ReleaseExecuteResponse>(
                    service, METHODID_RELEASE_EXECUTE)))
        .addMethod(
            getReleaseSessionMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<ReleaseSessionRequest, ReleaseSessionResponse>(
                    service, METHODID_RELEASE_SESSION)))
        .addMethod(
            getFetchErrorDetailsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<FetchErrorDetailsRequest, FetchErrorDetailsResponse>(
                    service, METHODID_FETCH_ERROR_DETAILS)))
        .build();
  }

  private abstract static class SparkConnectServiceBaseDescriptorSupplier
          ...
          serviceDescriptor =
              result =
                  io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
                      ...
                      .addMethod(getReleaseSessionMethod())
