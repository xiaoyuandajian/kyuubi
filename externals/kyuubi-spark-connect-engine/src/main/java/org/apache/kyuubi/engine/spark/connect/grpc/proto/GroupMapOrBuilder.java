...
public interface GroupMapOrBuilder
    extends
   ...
   * <code>repeated .spark.connect.Expression sorting_expressions = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression getSortingExpressions(int index);
  /**
   *
   *
   * <pre>
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Relation getInitialInput();
  /**
   *
   *
   * <pre>
   ...
   * <code>.spark.connect.Relation initial_input = 5;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.RelationOrBuilder getInitialInputOrBuilder();
   ...
   * <code>repeated .spark.connect.Expression initial_grouping_expressions = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression getInitialGroupingExpressions(
      int index);
  /**
   *
   *
   ...
   */
  com.google.protobuf.ByteString getTimeoutConfBytes();
}
