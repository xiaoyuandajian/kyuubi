...
public interface ExecutePlanResponseOrBuilder extends
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ArrowBatch getArrowBatch();
  /**
   * <code>.spark.connect.ExecutePlanResponse.ArrowBatch arrow_batch = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ArrowBatchOrBuilder getArrowBatchOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.SqlCommandResult getSqlCommandResult();
  /**
   * <pre>
   * Special case for executing SQL commands.
   * </pre>
   ...
   * <code>.spark.connect.ExecutePlanResponse.SqlCommandResult sql_command_result = 5;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.SqlCommandResultOrBuilder getSqlCommandResultOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteStreamOperationStartResult getWriteStreamOperationStartResult();
  /**
   * <pre>
   * Response for a streaming query.
   * </pre>
   ...
   * <code>.spark.connect.WriteStreamOperationStartResult write_stream_operation_start_result = 8;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteStreamOperationStartResultOrBuilder getWriteStreamOperationStartResultOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryCommandResult getStreamingQueryCommandResult();
  /**
   * <pre>
   * Response for commands on a streaming query.
   * </pre>
   ...
   * <code>.spark.connect.StreamingQueryCommandResult streaming_query_command_result = 9;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryCommandResultOrBuilder getStreamingQueryCommandResultOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.GetResourcesCommandResult getGetResourcesCommandResult();
  /**
   * <pre>
   * Response for 'SparkContext.resources'.
   * </pre>
   ...
   * <code>.spark.connect.GetResourcesCommandResult get_resources_command_result = 10;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.GetResourcesCommandResultOrBuilder getGetResourcesCommandResultOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult getStreamingQueryManagerCommandResult();
  /**
   * <pre>
   * Response for commands on the streaming query manager.
   * </pre>
   ...
   * <code>.spark.connect.StreamingQueryManagerCommandResult streaming_query_manager_command_result = 11;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResultOrBuilder getStreamingQueryManagerCommandResultOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ResultComplete getResultComplete();
  /**
   * <pre>
   * Response type informing if the stream is complete in reattachable execution.
   * </pre>
   ...
   * <code>.spark.connect.ExecutePlanResponse.ResultComplete result_complete = 14;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ResultCompleteOrBuilder getResultCompleteOrBuilder();
   ...
   * @return The metrics.
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.Metrics getMetrics();
  /**
   * <pre>
   * Metrics for the query execution. Typically, this field is only present in the last
   * batch of results and then represent the overall state of the query execution.
   ...
   * <code>.spark.connect.ExecutePlanResponse.Metrics metrics = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.MetricsOrBuilder getMetricsOrBuilder();
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ObservedMetrics> 
   ...
   * <code>repeated .spark.connect.ExecutePlanResponse.ObservedMetrics observed_metrics = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ObservedMetrics getObservedMetrics(int index);
  /**
   * <pre>
   * The metrics observed during the execution of the query plan.
   * </pre>
   ...
   * <code>repeated .spark.connect.ExecutePlanResponse.ObservedMetrics observed_metrics = 6;</code>
   */
  java.util.List<? extends org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ObservedMetricsOrBuilder> 
   ...
   * <code>repeated .spark.connect.ExecutePlanResponse.ObservedMetrics observed_metrics = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ObservedMetricsOrBuilder getObservedMetricsOrBuilder(
      int index);
  ...
  public org.apache.kyuubi.engine.spark.connect.proto.ExecutePlanResponse.ResponseTypeCase getResponseTypeCase();
}
