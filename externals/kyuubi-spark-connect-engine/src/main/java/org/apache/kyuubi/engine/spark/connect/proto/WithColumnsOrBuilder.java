...
public interface WithColumnsOrBuilder extends
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.proto.Expression.Alias> 
      getAliasesList();
  /**
   * <pre>
   * (Required)
   ...
   * <code>repeated .spark.connect.Expression.Alias aliases = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression.Alias getAliases(int index);
  /**
   * <pre>
   * (Required)
   * Given a column name, apply the corresponding expression on the column. If column
   ...
   * <code>repeated .spark.connect.Expression.Alias aliases = 2;</code>
   */
  java.util.List<? extends org.apache.kyuubi.engine.spark.connect.proto.Expression.AliasOrBuilder> 
   ...
   * <code>repeated .spark.connect.Expression.Alias aliases = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression.AliasOrBuilder getAliasesOrBuilder(
      int index);
}
