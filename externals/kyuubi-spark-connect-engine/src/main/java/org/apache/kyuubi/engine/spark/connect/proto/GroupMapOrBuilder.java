...
public interface GroupMapOrBuilder extends
   ...
   * <code>repeated .spark.connect.Expression grouping_expressions = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getGroupingExpressions(int index);
  /**
   * <pre>
   * (Required) Expressions for grouping keys.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression grouping_expressions = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getGroupingExpressionsOrBuilder(
      int index);
   ...
   * <code>repeated .spark.connect.Expression sorting_expressions = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getSortingExpressions(int index);
  /**
   * <pre>
   * (Optional) Expressions for sorting. Only used by Scala Sorted Group Map API.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression sorting_expressions = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getSortingExpressionsOrBuilder(
      int index);
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.Relation getInitialInput();
  /**
   * <pre>
   * Below fields are only used by (Flat)MapGroupsWithState
   * (Optional) Input relation for initial State.
   ...
   * <code>.spark.connect.Relation initial_input = 5;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.RelationOrBuilder getInitialInputOrBuilder();
   ...
   * <code>repeated .spark.connect.Expression initial_grouping_expressions = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getInitialGroupingExpressions(int index);
  /**
   * <pre>
   * (Optional) Expressions for grouping keys of the initial state input relation.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression initial_grouping_expressions = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getInitialGroupingExpressionsOrBuilder(
      int index);
