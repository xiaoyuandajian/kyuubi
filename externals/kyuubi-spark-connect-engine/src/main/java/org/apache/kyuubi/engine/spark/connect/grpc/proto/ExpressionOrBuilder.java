...
public interface ExpressionOrBuilder
   ...
   * @return The literal.
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.Literal getLiteral();
  /** <code>.spark.connect.Expression.Literal literal = 1;</code> */
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedAttribute
      getUnresolvedAttribute();
  /** <code>.spark.connect.Expression.UnresolvedAttribute unresolved_attribute = 2;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedAttributeOrBuilder
      getUnresolvedAttributeOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedFunction
      getUnresolvedFunction();
  /** <code>.spark.connect.Expression.UnresolvedFunction unresolved_function = 3;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedFunctionOrBuilder
      getUnresolvedFunctionOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.ExpressionString
      getExpressionString();
  /** <code>.spark.connect.Expression.ExpressionString expression_string = 4;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.ExpressionStringOrBuilder
      getExpressionStringOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedStar getUnresolvedStar();
  /** <code>.spark.connect.Expression.UnresolvedStar unresolved_star = 5;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedStarOrBuilder
      getUnresolvedStarOrBuilder();
   ...
   * @return The alias.
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.Alias getAlias();
  /** <code>.spark.connect.Expression.Alias alias = 6;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.AliasOrBuilder getAliasOrBuilder();
   ...
   * @return The cast.
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.Cast getCast();
  /** <code>.spark.connect.Expression.Cast cast = 7;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.CastOrBuilder getCastOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedRegex getUnresolvedRegex();
  /** <code>.spark.connect.Expression.UnresolvedRegex unresolved_regex = 8;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedRegexOrBuilder
      getUnresolvedRegexOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.SortOrder getSortOrder();
  /** <code>.spark.connect.Expression.SortOrder sort_order = 9;</code> */
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.LambdaFunction getLambdaFunction();
  /** <code>.spark.connect.Expression.LambdaFunction lambda_function = 10;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.LambdaFunctionOrBuilder
      getLambdaFunctionOrBuilder();
   ...
   * @return The window.
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.Window getWindow();
  /** <code>.spark.connect.Expression.Window window = 11;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.WindowOrBuilder getWindowOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedExtractValue
      getUnresolvedExtractValue();
  /**
   * <code>.spark.connect.Expression.UnresolvedExtractValue unresolved_extract_value = 12;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedExtractValueOrBuilder
      getUnresolvedExtractValueOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UpdateFields getUpdateFields();
  /** <code>.spark.connect.Expression.UpdateFields update_fields = 13;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UpdateFieldsOrBuilder
      getUpdateFieldsOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.UnresolvedNamedLambdaVariable
      getUnresolvedNamedLambdaVariable();
  /**
   * <code>
   * .spark.connect.Expression.UnresolvedNamedLambdaVariable unresolved_named_lambda_variable = 14;
   * </code>
  ...
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression
      ...
      getUnresolvedNamedLambdaVariableOrBuilder();

  /**
   * <code>.spark.connect.CommonInlineUserDefinedFunction common_inline_user_defined_function = 15;
   * </code>
   *
  ...
  org.apache.kyuubi.engine.spark.connect.grpc.proto.CommonInlineUserDefinedFunctionOrBuilder
      getCommonInlineUserDefinedFunctionOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.CallFunction getCallFunction();
  /** <code>.spark.connect.CallFunction call_function = 16;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.CallFunctionOrBuilder
      getCallFunctionOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.NamedArgumentExpression
      getNamedArgumentExpression();
  /** <code>.spark.connect.NamedArgumentExpression named_argument_expression = 17;</code> */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.NamedArgumentExpressionOrBuilder
      getNamedArgumentExpressionOrBuilder();
  ...
  public org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression.ExprTypeCase
      getExprTypeCase();
}
