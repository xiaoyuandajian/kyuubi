...
public interface NAReplaceOrBuilder extends
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.proto.NAReplace.Replacement> 
      getReplacementsList();
  /**
   * <pre>
   * (Optional) The value replacement mapping.
   ...
   * <code>repeated .spark.connect.NAReplace.Replacement replacements = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.NAReplace.Replacement getReplacements(int index);
  /**
   * <pre>
   * (Optional) The value replacement mapping.
   * </pre>
   ...
   * <code>repeated .spark.connect.NAReplace.Replacement replacements = 3;</code>
   */
  java.util.List<? extends org.apache.kyuubi.engine.spark.connect.proto.NAReplace.ReplacementOrBuilder> 
   ...
   * <code>repeated .spark.connect.NAReplace.Replacement replacements = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.NAReplace.ReplacementOrBuilder getReplacementsOrBuilder(
      int index);
}
