...
public interface AddArtifactsRequestOrBuilder extends
   ...
   * @return The batch.
   */
  org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.Batch getBatch();
  /**
   * <code>.spark.connect.AddArtifactsRequest.Batch batch = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.BatchOrBuilder getBatchOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.BeginChunkedArtifact getBeginChunk();
  /**
   * <pre>
   * The metadata and the initial chunk of a large artifact chunked into multiple requests.
   * The server side is notified about the total size of the large artifact as well as the
   ...
   * <code>.spark.connect.AddArtifactsRequest.BeginChunkedArtifact begin_chunk = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.BeginChunkedArtifactOrBuilder getBeginChunkOrBuilder();
   ...
   * @return The chunk.
   */
  org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.ArtifactChunk getChunk();
  /**
   * <pre>
   * A chunk of an artifact excluding metadata. This can be any chunk of a large artifact
   * excluding the first chunk (which is included in `BeginChunkedArtifact`).
   ...
   * <code>.spark.connect.AddArtifactsRequest.ArtifactChunk chunk = 5;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.ArtifactChunkOrBuilder getChunkOrBuilder();

  public org.apache.kyuubi.engine.spark.connect.proto.AddArtifactsRequest.PayloadCase getPayloadCase();
}
