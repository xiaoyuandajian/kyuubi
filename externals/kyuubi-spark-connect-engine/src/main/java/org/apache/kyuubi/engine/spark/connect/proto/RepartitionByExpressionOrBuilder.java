...
public interface RepartitionByExpressionOrBuilder extends
   ...
   * <code>repeated .spark.connect.Expression partition_exprs = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getPartitionExprs(int index);
  /**
   * <pre>
   * (Required) The partitioning expressions.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression partition_exprs = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getPartitionExprsOrBuilder(
      int index);
