...
public interface UnpivotOrBuilder
    extends
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression> getIdsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .spark.connect.Expression ids = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression getIds(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .spark.connect.Expression ids = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.ExpressionOrBuilder getIdsOrBuilder(int index);
   ...
   * @return The values.
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Unpivot.Values getValues();
  /**
   *
   *
   * <pre>
   ...
   * <code>optional .spark.connect.Unpivot.Values values = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Unpivot.ValuesOrBuilder getValuesOrBuilder();
   ...
   */
  com.google.protobuf.ByteString getVariableColumnNameBytes();
