...
public interface DropOrBuilder
    extends
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression> getColumnsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .spark.connect.Expression columns = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression getColumns(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .spark.connect.Expression columns = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.ExpressionOrBuilder getColumnsOrBuilder(
      int index);
