...
public interface CommandOrBuilder extends
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.CommonInlineUserDefinedFunction getRegisterFunction();
  /**
   * <code>.spark.connect.CommonInlineUserDefinedFunction register_function = 1;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.CommonInlineUserDefinedFunctionOrBuilder getRegisterFunctionOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperation getWriteOperation();
  /**
   * <code>.spark.connect.WriteOperation write_operation = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperationOrBuilder getWriteOperationOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.CreateDataFrameViewCommand getCreateDataframeView();
  /**
   * <code>.spark.connect.CreateDataFrameViewCommand create_dataframe_view = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.CreateDataFrameViewCommandOrBuilder getCreateDataframeViewOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperationV2 getWriteOperationV2();
  /**
   * <code>.spark.connect.WriteOperationV2 write_operation_v2 = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperationV2OrBuilder getWriteOperationV2OrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.SqlCommand getSqlCommand();
  /**
   * <code>.spark.connect.SqlCommand sql_command = 5;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.SqlCommandOrBuilder getSqlCommandOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteStreamOperationStart getWriteStreamOperationStart();
  /**
   * <code>.spark.connect.WriteStreamOperationStart write_stream_operation_start = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteStreamOperationStartOrBuilder getWriteStreamOperationStartOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryCommand getStreamingQueryCommand();
  /**
   * <code>.spark.connect.StreamingQueryCommand streaming_query_command = 7;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryCommandOrBuilder getStreamingQueryCommandOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.GetResourcesCommand getGetResourcesCommand();
  /**
   * <code>.spark.connect.GetResourcesCommand get_resources_command = 8;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.GetResourcesCommandOrBuilder getGetResourcesCommandOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommand getStreamingQueryManagerCommand();
  /**
   * <code>.spark.connect.StreamingQueryManagerCommand streaming_query_manager_command = 9;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandOrBuilder getStreamingQueryManagerCommandOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.CommonInlineUserDefinedTableFunction getRegisterTableFunction();
  /**
   * <code>.spark.connect.CommonInlineUserDefinedTableFunction register_table_function = 10;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.CommonInlineUserDefinedTableFunctionOrBuilder getRegisterTableFunctionOrBuilder();
  ...
  public org.apache.kyuubi.engine.spark.connect.proto.Command.CommandTypeCase getCommandTypeCase();
}
