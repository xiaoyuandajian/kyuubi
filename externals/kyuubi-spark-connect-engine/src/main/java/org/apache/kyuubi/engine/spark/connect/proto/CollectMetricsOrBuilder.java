...
public interface CollectMetricsOrBuilder extends
   ...
   * <code>repeated .spark.connect.Expression metrics = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getMetrics(int index);
  /**
   * <pre>
   * (Required) The metric sequence.
   * </pre>
   ...
   * <code>repeated .spark.connect.Expression metrics = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getMetricsOrBuilder(
      int index);
}
