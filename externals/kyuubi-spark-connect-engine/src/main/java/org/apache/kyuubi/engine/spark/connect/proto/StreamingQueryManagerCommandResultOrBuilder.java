...
public interface StreamingQueryManagerCommandResultOrBuilder extends
   ...
   * @return The active.
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.ActiveResult getActive();
  /**
   * <code>.spark.connect.StreamingQueryManagerCommandResult.ActiveResult active = 1;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.ActiveResultOrBuilder getActiveOrBuilder();
   ...
   * @return The query.
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.StreamingQueryInstance getQuery();
  /**
   * <code>.spark.connect.StreamingQueryManagerCommandResult.StreamingQueryInstance query = 2;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.StreamingQueryInstanceOrBuilder getQueryOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.AwaitAnyTerminationResult getAwaitAnyTermination();
  /**
   * <code>.spark.connect.StreamingQueryManagerCommandResult.AwaitAnyTerminationResult await_any_termination = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.AwaitAnyTerminationResultOrBuilder getAwaitAnyTerminationOrBuilder();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.ListStreamingQueryListenerResult getListListeners();
  /**
   * <code>.spark.connect.StreamingQueryManagerCommandResult.ListStreamingQueryListenerResult list_listeners = 7;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.ListStreamingQueryListenerResultOrBuilder getListListenersOrBuilder();

  public org.apache.kyuubi.engine.spark.connect.proto.StreamingQueryManagerCommandResult.ResultTypeCase getResultTypeCase();
}
