...
public interface ProjectOrBuilder
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression> getExpressionsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .spark.connect.Expression expressions = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.Expression getExpressions(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .spark.connect.Expression expressions = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.ExpressionOrBuilder getExpressionsOrBuilder(
      int index);
}
