...
public interface WriteOperationV2OrBuilder extends
   ...
   * <code>repeated .spark.connect.Expression partitioning_columns = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getPartitioningColumns(int index);
  /**
   * <pre>
   * (Optional) List of columns for partitioning for output table created by `create`,
   * `createOrReplace`, or `replace`
   ...
   * <code>repeated .spark.connect.Expression partitioning_columns = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getPartitioningColumnsOrBuilder(
      int index);
...
java.lang.String defaultValue);
   ...
   * @return The mode.
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperationV2.Mode getMode();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getOverwriteCondition();
  /**
   * <pre>
   * (Optional) A condition for overwrite saving mode
   * </pre>
   ...
   * <code>.spark.connect.Expression overwrite_condition = 8;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getOverwriteConditionOrBuilder();
}
