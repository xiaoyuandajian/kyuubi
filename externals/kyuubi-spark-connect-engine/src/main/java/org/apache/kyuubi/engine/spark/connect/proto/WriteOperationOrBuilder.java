...
public interface WriteOperationOrBuilder extends
   ...
   * @return The table.
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperation.SaveTable getTable();
  /**
   * <code>.spark.connect.WriteOperation.SaveTable table = 4;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperation.SaveTableOrBuilder getTableOrBuilder();
   ...
   * @return The mode.
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperation.SaveMode getMode();
   ...
   * @return The bucketBy.
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperation.BucketBy getBucketBy();
  /**
   * <pre>
   * (Optional) Bucketing specification. Bucketing must set the number of buckets and the columns
   * to bucket by.
   ...
   * <code>.spark.connect.WriteOperation.BucketBy bucket_by = 8;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.WriteOperation.BucketByOrBuilder getBucketByOrBuilder();
...
java.lang.String defaultValue);
  ...
  public org.apache.kyuubi.engine.spark.connect.proto.WriteOperation.SaveTypeCase getSaveTypeCase();
}
