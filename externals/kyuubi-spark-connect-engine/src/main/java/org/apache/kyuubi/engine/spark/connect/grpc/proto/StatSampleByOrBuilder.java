...
public interface StatSampleByOrBuilder
    extends
   ...
   */
  java.util.List<org.apache.kyuubi.engine.spark.connect.grpc.proto.StatSampleBy.Fraction>
      getFractionsList();
  /**
   *
   *
   ...
   * <code>repeated .spark.connect.StatSampleBy.Fraction fractions = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.grpc.proto.StatSampleBy.Fraction getFractions(int index);
  /**
   *
   *
   * <pre>
