...
public interface JoinOrBuilder extends
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.Expression getJoinCondition();
  /**
   * <pre>
   * (Optional) The join condition. Could be unset when `using_columns` is utilized.
   * This field does not co-exist with using_columns.
   ...
   * <code>.spark.connect.Expression join_condition = 3;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.ExpressionOrBuilder getJoinConditionOrBuilder();
   ...
   * @return The joinType.
   */
  org.apache.kyuubi.engine.spark.connect.proto.Join.JoinType getJoinType();
   ...
   */
  org.apache.kyuubi.engine.spark.connect.proto.Join.JoinDataType getJoinDataType();
  /**
   * <pre>
   * (Optional) Only used by joinWith. Set the left and right join data types.
   * </pre>
   ...
   * <code>optional .spark.connect.Join.JoinDataType join_data_type = 6;</code>
   */
  org.apache.kyuubi.engine.spark.connect.proto.Join.JoinDataTypeOrBuilder getJoinDataTypeOrBuilder();
}
